...
export default function AboutPage() {
  return (
    <PageShell className="py-16 sm:py-24">
      ...
      <Section title="Certificates" subtitle="Courses and certifications earned along the way.">
        <CertificateList certificates={certificates} />
      </Section>

      <Section title="Organizations" subtitle="Communities and causes I've been part of.">
